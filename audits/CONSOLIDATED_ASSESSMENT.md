...
*Prepared by orchestrated multi-agent audit (5× Sonnet, web-verified against 2026 manufacturer sources) with reconciliation and recomputation. All proposed score changes rest on a cited factual basis or the report's own stated rules; see the per-brand audit files for full evidence, source URLs, and worked arithmetic.*
